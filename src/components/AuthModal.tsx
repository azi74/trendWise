...
const AuthModal = () => {
  ...
  const handleGoogleAuth = () => {
    // Demo Google auth - redirect to profile
  ...
  return (
    <div className="w-full max-w-md mx-auto p-6">
      ...
      <button
        ...
        className="w-full mb-6 bg-white hover:bg-gray-100 text-gray-900 font-semibold py-3 px-6 rounded-xl transition-all duration-200 flex items-center justify-center space-x-3 border border-gray-300"
      >
      ...
      {isLogin && (
        <div className="mt-4 text-center">
          <p className="text-sm text-gray-500">
            Demo: Use any email/password or Google to access profile
          </p>
        </div>
      )}
    </div>
