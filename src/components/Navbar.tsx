      ...
      return (
        <Dialog open={showAuthModal} onOpenChange={setShowAuthModal}>
          ...
          <DialogContent className="sm:max-w-md bg-gray-900 border-gray-800">
            ...
            <DialogClose className="absolute right-4 top-4 rounded-full bg-red-500 hover:bg-red-600 p-1 transition-colors">
      ...
      <Sheet>
        ...
        <SheetContent side="bottom" className="bg-gray-900 border-gray-800 rounded-t-2xl">
          <SheetHeader>
            ...
            <SheetClose className="absolute right-4 top-4 rounded-full bg-red-500 hover:bg-red-600 p-1 transition-colors">
              <X className="h-4 w-4 text-white" />
              <span className="sr-only">Close</span>
            </SheetClose>
          </SheetHeader>
